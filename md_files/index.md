...
actions:
  - text: 开始阅读
    link: ./doc_related/special_thanks.md
    type: primary

features:
  - title: 内容详尽
    details: 你可以在此处找到几乎所有的常用信息与教程
  - title: 更新及时
    details: 完全可以当工具书使用，基本上日常生活能遇到的方方面面都有涉及
  - title: 现代化
    details: 可在电脑、手机上完美显示，规避了PDF版本难以使用的问题

tags: ["主页", "捐赠", "打赏", "捐助", "助力", "捐款", "赞助"]
---
